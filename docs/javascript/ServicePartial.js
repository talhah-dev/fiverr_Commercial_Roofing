...
if (servicePartials.length) {
  ...
  const configs = {
    home: {
      ...
      cards: [
        { image: "https://media.istockphoto.com/id/2220715743/photo/removing-asbestos-for-a-new-roof.jpg?s=612x612&w=0&k=20&c=-Q6XoKUntXk8xWuFc53EOiNDMgkZLAgZ1MWBRccx7to=", alt: "Asbestos roofing services", icon: "fa-solid fa-triangle-exclamation", title: "Asbestos Roofing Services", text: "Safe asbestos roofing surveys, removal and replacement solutions", detailKey: "asbestos-roofing-services" },
        { image: "https://media.istockphoto.com/id/2157073122/photo/aerial-view-of-an-apartment-building-with-flat-roof-in-construction-ballasted-system-with.jpg?s=612x612&w=0&k=20&c=4IIybZ2taalV6R5P_pwqubvQ9F7_b13t7tv2m6jJvzI=", alt: "Flat roofing systems", icon: "fa-solid fa-house", title: "Flat Roofing Systems", text: "Flat roof installation, renewal and maintenance for commercial sites", detailKey: "flat-roofing-systems" },
        ...
        { image: "https://media.istockphoto.com/id/1172013285/photo/workman-using-pneumatic-nail-gun-install-tile-on-roof-of-new-house-under-construction.jpg?s=612x612&w=0&k=20&c=5-9vPCpGwYoh5ylnswUV0xuFQr4dk3E36I2KhsJQ6M8=", alt: "Roof repair services", icon: "fa-solid fa-wrench", title: "Roof Repairs", text: "Fast roof repairs for leaks, storm damage and general wear", detailKey: "roof-repairs" },
        { image: "https://media.istockphoto.com/id/2222923372/photo/worker-fix-leaking-pipe-in-ceiling-close-up-of-a-stain-on-the-ceiling.jpg?s=612x612&w=0&k=20&c=xrHg_SMtG1G2Xph0vLkvcOBgDvSsj78PJfHvhBBwTlU=", alt: "Emergency roofing services", icon: "fa-solid fa-bell", title: "Emergency Roofing Services", text: "Rapid response emergency roofing support when urgent issues arise", detailKey: "emergency-roofing-services" }
      ],
